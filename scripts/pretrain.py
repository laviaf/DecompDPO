...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='configs/pretrain/pretrain.yml')
    ...
    # log_dir = 'logs_diffusion_full/training_error_rm25+_2023_07_26__11_30_13'
    ...
    # ckpt = torch.load(log_dir + '/checkpoints/50000.pt', map_location=args.device)
